...
namespace Connect.DocBrowser.Core.Data
{
    public class Sprocs
    {
        ...
        //  AND i2.Topic=@Topic
        // ;  
        public static Item GetTopic(int moduleId, string locale, string version, int edition, string topic)
        {
            using (var context = DataContext.Instance())
            {
                return context.ExecuteSingleOrDefault<Item>(System.Data.CommandType.StoredProcedure,
        ...
        //  AND (i2.Edition & @Edition > 0 OR i2.Edition=0)
        // ;  
        public static IEnumerable<string> GetTopicList(int moduleId, string locale, string version, int edition)
        {
            using (var context = DataContext.Instance())
            {
                return context.ExecuteQuery<string>(System.Data.CommandType.StoredProcedure,
